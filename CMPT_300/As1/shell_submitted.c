...
void printHistory()
{
    ...
    int commandIndex = commandCounter - 1;
...
void SIGINT_handler()
{
    ...
    writeString("1. help:\n", "info");
    writeString("'help' is a builtin command. Displays information about the passed command. If no argument provided then it displays all the commands if no argument is provided. Takes only one argument.\n", "normal");
    writeString("2. exit:\n", "info");
    writeString("'exit' is a builtin command. Exits the shell. Takes no other arguments.\n", "normal");
    writeString("3. pwd:\n", "info");
    writeString("'pwd' is a builtin command. Prints the current working directory. Takes no other arguments.\n", "normal");
    writeString("4. cd:\n", "info");
    writeString("'cd' is a builtin command. Changes the current working directory to the directory specified. Takes only one argument.\n", "normal");
    writeString("5. history:\n", "info");
    writeString("'history' is a builtin command. Displays the 10 most recent commands entered. If less than 10 commands were entered then only those are displayed. Takes no other arguments.\n", "normal");
}
